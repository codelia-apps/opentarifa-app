...
import com.opentarifa.app.data.local.ThemeMode
...
import com.opentarifa.app.ui.pvpc.SummaryScreen
import com.opentarifa.app.ui.pvpc.TomorrowScreen
import com.opentarifa.app.ui.settings.AboutScreen
import com.opentarifa.app.ui.settings.SettingsScreen
import com.opentarifa.app.ui.theme.OpenTarifaTheme
import com.opentarifa.app.ui.tools.ApplianceCalculatorScreen
import com.opentarifa.app.ui.tools.SavingsTipsScreen
import com.opentarifa.app.ui.tools.SocialBonusScreen
import com.opentarifa.app.ui.tools.ToolsScreen
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            OpenTarifaTheme(darkTheme = darkTheme) {
                OpenTarifaApp(pendingRoute = pendingRoute, onPendingRouteHandled = { pendingRoute = null })
            }
        }
    }
    ...
    companion object {
        const val EXTRA_OPEN_TODAY = "com.opentarifa.app.EXTRA_OPEN_TODAY"
        const val EXTRA_OPEN_TOMORROW = "com.opentarifa.app.EXTRA_OPEN_TOMORROW"
    }
}
 ...
 */
@Composable
fun OpenTarifaApp(pendingRoute: String? = null, onPendingRouteHandled: () -> Unit = {}) {
 ...
 */
@Composable
private fun OpenTarifaBottomNavBar(currentRoute: String?, onSelect: (Screen) -> Unit) {
    Column {
